...
Ниже — минимальная инструкция для запуска проекта на обычном компьютере. Для обучения, теста на исторических данных и анализа достаточно обычного компьютера.
Сервер имеет смысл только для процессов, которые должны работать постоянно.
